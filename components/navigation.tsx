...
export default function Navigation() {
  ...
  return (
    <div className="flex justify-center border-b-2 border-zinc-200 bg-white dark:border-darkmode-border dark:bg-darkmode-nav sm:h-screen sm:w-4/12 sm:flex-col sm:border-r-4 xl:w-3/12 standalone:pt-10">
