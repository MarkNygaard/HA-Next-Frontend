      ...
      <div className="w-full flex-1 space-y-1 pb-3 pt-3 sm:px-3 sm:pt-12">
          ...
          <a className="group flex items-center rounded-[75px] font-medium sm:hover:bg-tile-bg sm:dark:hover:bg-zinc-800 md:px-4">
            ...
            <div className="p-2 sm:px-4">
              <svg
                ...
                className="h-6 w-6 text-zinc-900 group-hover:text-white dark:text-zinc-400 dark:group-hover:text-zinc-200"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="1.5"
        ...
        <Link href="/settings">
          <a className="group flex items-center rounded-[75px] font-medium  sm:hover:bg-tile-bg sm:dark:hover:bg-zinc-800 md:px-4">
            ...
            <div className="p-2 text-xl text-zinc-900 group-hover:text-white dark:text-zinc-400 sm:px-4">
