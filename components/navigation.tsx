...
export default function Navigation() {
  ...
  return (
    <div
      id="header"
      className="flex w-full justify-center border-b-2 border-zinc-200 bg-white pt-2 dark:border-darkmode-border dark:bg-darkmode-nav sm:h-screen sm:w-4/12 sm:flex-col sm:border-r-4 xl:w-3/12 standalone:fixed standalone:z-10 standalone:pt-10"
    >
